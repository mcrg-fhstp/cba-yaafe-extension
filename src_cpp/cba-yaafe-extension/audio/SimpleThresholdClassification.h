...
#ifndef SIMPLETHRESHOLDCLASSIFICATION_H_
#define SIMPLETHRESHOLDCLASSIFICATION_H_

#include "yaafe-core/ComponentHelpers.h"

#define SIMPLETHRESHOLDCLASSIFICATION_ID "SimpleThresholdClassification"

namespace YAAFE
{

class SimpleThresholdClassification: public YAAFE::StateLessOneInOneOutComponent<SimpleThresholdClassification>
{
public:
    SimpleThresholdClassification();
    virtual ~SimpleThresholdClassification();

    virtual const std::string getIdentifier() const { return SIMPLETHRESHOLDCLASSIFICATION_ID;};
...
#endif /* SIMPLETHRESHOLDCLASSIFICATION_H_ */
