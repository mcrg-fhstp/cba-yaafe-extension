...
#define DILATIONFILTER_ID "DilationFilter"

namespace YAAFE
{

class DilationFilter: public YAAFE::ComponentBase<DilationFilter>
{
public:
    DilationFilter();
    virtual ~DilationFilter();

    virtual const std::string getIdentifier() const { return DILATIONFILTER_ID;};
