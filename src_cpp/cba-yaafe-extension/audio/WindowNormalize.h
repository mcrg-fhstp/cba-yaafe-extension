...
#ifndef WINDOWNORMALIZE_H
#define WINDOWNORMALIZE_H

#include "yaafe-core/Component.h"
#include <Eigen/Dense>

#define WINDOWNORMALIZE_ID "WindowNormalize"

namespace YAAFE
{

class WindowNormalize: public YAAFE::ComponentBase<WindowNormalize>
{
public:
    WindowNormalize();
    virtual ~WindowNormalize();

    virtual const std::string getIdentifier() const { return WINDOWNORMALIZE_ID;};
