...
#ifndef DCOFFSETFILTER_H_
#define DCOFFSETFILTER_H_

#include "yaafe-core/ComponentHelpers.h"

#define DCOFFSETFILTER_ID "DCOffsetFilter"

namespace YAAFE
{

class DCOffsetFilter: public YAAFE::StateLessOneInOneOutComponent<DCOffsetFilter>
{
public:
    DCOffsetFilter();
    virtual ~DCOffsetFilter();

    const std::string getIdentifier() const  { return DCOFFSETFILTER_ID; }
