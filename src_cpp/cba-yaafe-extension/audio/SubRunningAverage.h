...
#ifndef SUBRUNNINGAVERAGE_H_
#define SUBRUNNINGAVERAGE_H_

#include "yaafe-core/ComponentHelpers.h"

#define SUBRUNNINGAVERAGE_ID "SubRunningAverage"

namespace YAAFE
{

class SubRunningAverage: public YAAFE::StateLessOneInOneOutComponent<SubRunningAverage>
{
public:
    SubRunningAverage();
    virtual ~SubRunningAverage();

    virtual const std::string getIdentifier() const { return SUBRUNNINGAVERAGE_ID;};
